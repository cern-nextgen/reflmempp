...
constexpr size_t array_size = 10e6;
constexpr size_t vector_size = 10e6;
...
#define BENCHMARK_ALL_TYPES(OP, MEMBERS, TYPE, SIZE)                                                                   \
  ...
  BENCHMARK_TEMPLATE(BM_##OP##AoS, AoS##MEMBERS##Arr<TYPE, array_size>)                                                \
      ->Unit(benchmark::kMillisecond)                                                                                  \
      ->UseManualTime();                                                                                               \
  BENCHMARK_TEMPLATE(BM_##OP##SoA, SoA##MEMBERS##Arr<TYPE, array_size>)                                                \
      ->Unit(benchmark::kMillisecond)                                                                                  \
      ->UseManualTime();                                                                                               \
  BENCHMARK_TEMPLATE(BM_##OP##AoS, AoS##MEMBERS##Vec<TYPE, vector_size>)                                               \
      ->Unit(benchmark::kMillisecond)                                                                                  \
      ->UseManualTime();                                                                                               \
  BENCHMARK_TEMPLATE(BM_##OP##SoA, SoA##MEMBERS##Vec<TYPE, vector_size>)                                               \
      ->Unit(benchmark::kMillisecond)                                                                                  \
      ->UseManualTime();
...
BENCHMARK_ALL_MEMBERS(float, vector_size)
BENCHMARK_ALL_MEMBERS(double, vector_size)
